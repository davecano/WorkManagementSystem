<%@ Page Title="" Language="C#" MasterPageFile="~/students/student.master" AutoEventWireup="true" CodeFile="SubHomework.aspx.cs" Inherits="students_SubHomework" %>
                   ...
                   <tr>
                    ...
                    <td><%#Eval("teacherID")%></td>       
                      <td><%#Eval("teacherName") %></td>     
                       <td>
                           <asp:Label ID="Lblatesthw" runat="server" Text='<%#Eval("NOsubhw") %>'></asp:Label></td>     
